...
import { Menu, Lock, CheckCircle2, Circle, Home, Trophy, BookOpen } from 'lucide-react';
import { cn } from '@/lib/utils';
import { TheoryModule, THEORY_MODULES } from '@/lib/data/theory';
                    ...
                    <nav className="space-y-1">
                        {THEORY_MODULES.map((module, index) => {
                            ...
                            const steps = [
                                ...
                                { id: 'quiz', icon: Link, label: 'Validazione Tecnica' },
